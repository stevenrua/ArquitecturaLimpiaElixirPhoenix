defmodule MatricularCursoCa.Application do
  alias MatricularCursoCa.Infrastructure.EntryPoint.ApiRest
  alias MatricularCursoCa.Config.{AppConfig, ConfigHolder}
  alias MatricularCursoCa.Utils.CertificatesAdmin
  alias MatricularCursoCa.Utils.CustomTelemetry
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: MatricularCursoCa.Supervisor]
  ...
  def env_children(_other_env) do
    [
			{MatricularCursoCa.Infrastructure.Adapters.Repository.Repo, []},]
  end
end
